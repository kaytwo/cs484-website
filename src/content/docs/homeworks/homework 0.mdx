...
repository](https://github.com/swad-cs-uic/homework0). This repository is
**not** automatically shared with the instructors, so if you want us to see your code and help
when needed, please share it with `kaytwo` and `nkgotcode`.
To complete this assignment, make the changes described below, ensure that your
web application is available on the Internet, and then submit via Gradescope.  
