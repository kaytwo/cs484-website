...
We will be hacking the UIC [Juiceshop](https://cs484-f25.kaytwo.org). This is an intentionally vulnerable full stack web
...
board](https://cs484-f25.kaytwo.org/balancer/score-board/). You receive nothing
