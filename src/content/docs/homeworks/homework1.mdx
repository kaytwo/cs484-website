...
due: "2023-09-08T15:00:00"
github_link: https://classroom.github.com/a/d1FDyx0T
solution_video: https://youtu.be/nlZ-GRQetbE
release: "2023-08-28T22:00:00"
---

import { localizeTime, formatTime } from "../../../utils.ts";
import { Content as Deadlines } from "../../../components/Deadlines.md";

Because the deadline has passed, heres a <a
href="{frontmatter.solution_video}">solution video</a> you can watch to see how
I would blind code this assignment.

## {frontmatter.description}

**Due**: {formatTime(localizeTime(frontmatter.due))}

**Quickstart**: To use free Codespaces to do your assignment, please <a
href={frontmatter.github_link}>accept it via this GitHub Classroom link</a>. To
just create a new repository under your own GitHub account, you can create a new
**private** repository from [this
template](https://github.com/swad-cs-uic/homework1). Sharing your code,
