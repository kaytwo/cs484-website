...
Remember that this assignment is not worth any points, but if you don't get
started finding a good project idea, I will be grading your later checkpoints
based on my personal opinion rather than the expectations that we set together.
