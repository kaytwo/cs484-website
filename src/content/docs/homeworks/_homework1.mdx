...
`npm run test` will run the test suite locally.
...
| Task                                                                 | Points |
| -------------------------------------------------------------------- | ------ |
|"(5pts) should display products on home page" | 5    |
...
This assignment is due at{formatTime(localizeTime(frontmatter.due))}. Extra
